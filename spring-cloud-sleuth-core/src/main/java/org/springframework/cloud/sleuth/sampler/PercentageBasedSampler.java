 ...
 *     <li>We apply the Zipkin algorithm to define whether we should sample or not (we're
 *     comparing against threshold) - https://github.com/openzipkin/zipkin-java/blob/master/zipkin-java-core/src/main/java/io/zipkin/TraceIdSampler.java#L78</li>
 * </ul>
 *
